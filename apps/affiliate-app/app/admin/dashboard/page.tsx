    ...
    try {
      ...
      if (data.success) {
        ...
        setStats({
          ...
          activeAffiliates: data.data.affiliates?.length || 0,
    ...
    <div className="min-h-screen bg-slate-50 font-sans pb-12">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-6 space-y-6">
        ...
        <section className="text-left space-y-3.5">
          <div>
            <h1 className="text-2xl sm:text-3xl font-black text-slate-900 tracking-tight mb-2">Command Center 🚀</h1>
            <p className="text-slate-500 text-sm font-medium leading-relaxed">
              Ringkasan performa ekosistem affiliate, arus penjualan snack, stok produk, dan verifikasi penarikan komisi.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            >
              ...
              <div className="relative z-10 max-w-[80%]">
                ...
                <p className="text-xs text-slate-500 font-semibold leading-relaxed mt-1">
                  Kelola dan pantau seluruh transaksi penjualan & komisi.
                </p>
              </div>
            ...
            >
              ...
              <div className="relative z-10 max-w-[80%]">
                ...
                <p className="text-xs text-slate-500 font-semibold leading-relaxed mt-1">
                  Atur status aktif/nonaktif mitra & target penjualan.
                </p>
              </div>
