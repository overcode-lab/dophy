  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (typeof window !== "undefined") {
        ...
        localStorage.setItem("dophy_role", "affiliate");
      }
    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4 sm:p-6 font-sans">
      ...
      >
        ...
        <div className="text-left space-y-3">
          ...
          <h1 className="text-2xl sm:text-3xl font-black tracking-tight text-slate-900">Masuk Mitra Affiliator</h1>
          <p className="text-slate-500 text-xs sm:text-sm font-medium leading-relaxed max-w-sm">
            Pantau komisi real-time, statistik referral, dan kelola penarikan dana.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-1 text-left">
            <label className="text-xs font-bold text-slate-700 block">Email Affiliator</label>
