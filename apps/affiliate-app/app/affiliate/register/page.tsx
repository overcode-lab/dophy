...
export default function AffiliateRegisterPage() {
  ...
  const validateForm = () => {
    ...
    if (!trimmedName) {
      ...
      newErrors.full_name = "Nama maksimal 70 karakter";
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch("/api/affiliators/register", {
        method: "POST",
    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4 sm:p-6 font-sans">
      ...
      >
        ...
        <div className="text-left space-y-3">
          ...
          <h1 className="text-2xl sm:text-3xl font-black tracking-tight text-slate-900">Daftar Affiliator DOPHY</h1>
          <p className="text-slate-500 text-xs sm:text-sm font-medium leading-relaxed max-w-sm">
            Dapatkan komisi dari setiap penjualan snack dengan kode referral unikmu!
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <div className="space-y-1 text-left">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[10px] text-slate-400 font-semibold">{formData.full_name.length}/70</span>
              </div>
      ...
      <CustomConfirmModal
        ...
        description={`Selamat! Akun Affiliator Anda telah aktif. Kode referral unik Anda adalah: ${
