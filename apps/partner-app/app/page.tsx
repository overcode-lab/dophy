      ...
      <section className="max-w-5xl mx-auto w-full px-5 py-6 sm:py-12 text-left sm:text-center z-10 space-y-6 sm:space-y-8 my-auto">
        ...
        >
          <h1 className="text-3xl sm:text-6xl font-black tracking-tight text-slate-900 max-w-4xl sm:mx-auto leading-[1.15]">
            Ubah Hobi Ngemil & Share Creator Code Jadi <span className="text-dophy-600">Penghasilan Nyata</span> 🍿💸
          </h1>
          <p className="text-slate-600 text-sm sm:text-lg max-w-2xl sm:mx-auto font-medium leading-relaxed">
            Bergabunglah sebagai Creator Partner DOPHY! Dapatkan Creator Royalty menarik dari setiap penjualan produk snack DOPHY. Pantau akumulasi royalti secara real-time dan cairkan dana kapan saja langsung ke rekening bank atau e-wallet milikmu.
          </p>
        </motion.div>
        ...
        >
          {/* Card 1: Masuk / Login Creator Partner */}
          <Link
            href="/partner/login"
          ...
          >
            ...
            <div className="relative z-10 space-y-1">
              ...
              <p className="text-[11px] sm:text-xs text-slate-500 font-medium">Pantau saldo royalti & histori</p>
            </div>
          ...
          {/* Card 2: Daftar Creator Partner Baru */}
          <Link
          ...
          >
            ...
            <div className="relative z-10 space-y-1">
              ...
              <p className="text-[11px] sm:text-xs text-slate-500 font-medium">Dapatkan Creator Code unik</p>
            </div>
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <span>Creator Code Unik</span>
          </div>
          <div className="flex items-center gap-2">
            <span className="w-1.5 h-1.5 rounded-full bg-emerald-500" />
            <span>Creator Royalty Real-Time</span>
          </div>
          <div className="flex items-center gap-2">
