    ...
    async (page = 1, isAppend = false) => {
      ...
      try {
        ...
        if (result.success) {
          ...
          if (result.data.partners) setPartnersList(result.data.partners);
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 px-1">
              <div>
                ...
                <p className="text-xs text-slate-500 font-medium mt-0.5">
                  Kelola dan pantau seluruh catatan penjualan snack beserta distribusi Creator Royalty.
                </p>
              </div>
            ...
            <div className="space-y-2.5">
              ...
              <div className="flex items-center gap-2">
                <div className="relative flex-1">
                  ...
                  <input
                    type="text"
                    placeholder="Cari nama produk, Creator Partner, atau Creator Code di seluruh database..."
                    value={searchQuery}
              ...
              <div className="p-10 rounded-3xl bg-white border border-slate-200/80 shadow-xs text-center space-y-3">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-slate-400 font-medium max-w-sm mx-auto">
                    {debouncedSearch || isFilterActive
                      ? "Coba sesuaikan filter atau kata kunci pencarian nama produk/Creator Partner yang lain."
